                ...
                <Radio.Group value={default_mode} onChange={(e) => setDefaultMode(e)}>
                    <Radio value="duration">
                        ...
                        <Input size="mini" value={mode_conf.duration} onBlur={(e) => {
                            ...
                            from === 'default' && updateTaskConfig('duration', parseInt(e.target.value));
                    ...
                    <Radio value="round_num">
                        ...
                        <Input size="mini" value={mode_conf.round_num} onBlur={(e) => {
                            ...
                            from === 'default' && updateTaskConfig('round_num', parseInt(e.target.value));
                ...
                <div className='other-config-detail'>
                    <div className='config-detail-item'>
                        ...
                        <Input size="mini" value={mode_conf.concurrency} onBlur={(e) => {
                            ...
                            from === 'default' && updateTaskConfig('concurrency', parseInt(e.target.value));
                        }} />
                    </div>
                    <div className='config-detail-item'>
                        <span>预热: </span>
                        <Input size="mini" value={mode_conf.reheat_time} onBlur={(e) => {
                            ...
                            from === 'default' && updateTaskConfig('reheat_time', parseInt(e.target.value));
                        }} />s
                    </div>
                </div>
            </div>
                ...
                <div className='other-config-detail'>
                    <div className='config-detail-item'>
                        ...
                        <Input size="mini" value={mode_conf.start_concurrency} onBlur={(e) => {
                            ...
                            from === 'default' && updateTaskConfig('start_concurrency', parseInt(e.target.value));
                        }} />
                    </div>
                    <div className='config-detail-item'>
                        <span>并发数步长: </span>
                        <Input size="mini" value={mode_conf.step} onBlur={(e) => {
                            ...
                            from === 'default' && updateTaskConfig('step', parseInt(e.target.value));
                        }} />
                    </div>
                    <div className='config-detail-item'>
                        <span>步长执行时长: </span>
                        <Input size="mini" value={mode_conf.step_run_time} onBlur={(e) => {
                            ...
                            from === 'default' && updateTaskConfig('step_run_time', parseInt(e.target.value));
                        }} />s
                    </div>
                    <div className='config-detail-item'>
                        <span>最大并发数: </span>
                        <Input size="mini" value={mode_conf.max_concurrency} onBlur={(e) => {
                            ...
                            from === 'default' && updateTaskConfig('max_concurrency', parseInt(e.target.value));
                        }} />次
                    </div>
                    <div className='config-detail-item'>
                        <span>稳定持续时长: </span>
            ...
            <div className='task-config-container'>
                ...
                <div className='item' style={{ marginBottom: '30px' }}>
                    ...
                    <Radio.Group value={task_type} onChange={(e) => {
                        ...
                        from === 'default' && updateTaskConfig('task_type', parseInt(e));
                    }}>
                ...
                <div className='item'>
                    ...
                    <Radio.Group value={mode} onChange={(e) => {
                        ...
                        from === 'default' && updateTaskConfig('mode', parseInt(e));
                    }} >
